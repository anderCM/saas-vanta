module Providers
  class ImportOrchestrator < BaseService
    ...
    def call
      ...
      creator = Providers::CreateNewProviders.new(records: records, enterprise: @enterprise)
      creator.call
    ...
    def transform_single_row(row)
      ...
      provider_attrs = build_provider_attributes(row)

      { attrs: provider_attrs, meta: { row: row_number } }
    end
